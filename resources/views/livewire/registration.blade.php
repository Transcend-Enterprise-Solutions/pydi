<section class="px-2 py-12 mx-auto md:px-12 lg:px-32 max-w-7xl"  wire:key="{{ $submitCount }}">
    <div class="max-w-lg mx-auto md:max-w-xl md:w-full">
        <div class="flex flex-col text-center">
            <h1 class="text-2xl font-semibold tracking-tight text-gray-900">Registration Form</h1>
            <p class="text-sm font-medium text-gray-500">Provide your information to register.</p>
        </div>

        @if (session()->has('message'))
            <div class="bg-green-100 border border-green-400 text-green-500 px-4 py-3 rounded relative mt-4" role="alert">
            ...
            <div class="p-4 md:p-10 bg-white border shadow-lg rounded-2xl">
                ...
                <div>
                    ...
                    <div class="mt-3 gap-2 lg:columns-2 sm:columns-1">
                        <div class="w-full">
                            <label for="first_name" class="text-sm text-gray-500 font-bold">Firstname <span class="text-red-600">*</span></label>
                        ...
                        <div class="w-full">
                            <label for="middle_name" class="text-sm text-gray-500 font-bold">Middlename</label>
                    ...
                    <div class="mt-4 gap-2 lg:columns-2 sm:columns-1">
                        <div class="w-full">
                            <label for="last_name" class="text-sm text-gray-500 font-bold">Lastname <span class="text-red-600">*</span></label>
                        ...
                        <div class="w-full">
                            <label for="name_extension" class="text-sm text-gray-500 font-bold">Name Extension</label>
                ...
                <div class="mt-8">
                    ...
                    <div class="mt-3 gap-2 lg:columns-2 sm:columns-1">
                        <div class="w-full">
                            <label for="email" class="text-sm text-gray-500 font-bold">Email <span class="text-red-600">*</span></label>
                        ...
                        <div class="w-full">
                            <label for="mobile_number" class="text-sm text-gray-500 font-bold">Mobile Number <span class="text-red-600">*</span></label>
                ...
                <div class="mt-8">
                    ...
                    <div class="mt-3 gap-2 lg:columns-2 sm:columns-1">
                        <div class="w-full">
                            <label for="position_designation" class="text-sm text-gray-500 font-bold">Position/Designation <span class="text-red-600">*</span></label>
                        ...
                        <div class="w-full">
                            <label for="government_agency" class="text-sm text-gray-500 font-bold">Government Agency <span class="text-red-600">*</span></label>
                    ...
                    <div class="mt-4 gap-2 lg:columns-2 sm:columns-1">
                        <div class="w-full">
                            <label for="office_department_division" class="text-sm text-gray-500 font-bold">Office/Department/Division <span class="text-red-600">*</span></label>
                        ...
                        <div class="w-full">
                            <label for="office_address" class="text-sm text-gray-500 font-bold">Office Address <span class="text-red-600">*</span></label>
                    ...
                    <div class="mt-3 gap-2 lg:columns-2 sm:columns-1">
                        <div>
                            <div class="relative inline-block" x-data="{ tooltip: false }">
                                <i class="bi bi-info-circle-fill text-blue-500 cursor-pointer"
                                @mouseenter="tooltip = true" @mouseleave="tooltip = false"></i>
                                <div x-show="tooltip"
                                    class="absolute left-full top-1/2 transform -translate-y-1/2 ml-2 z-10 w-auto px-4 py-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm dark:bg-gray-500 transition-opacity duration-300"
                                    style="display: none;">
                            ...
                            <label class="text-sm text-gray-500 font-bold" for="password">
                                Password:
                        ...
                        <div>
                            ...
                            <label class="text-sm text-gray-500 font-bold" for="c_password">
                                Confirm Password:
                                <span class="text-red-600">*</span>
                            </label>
                ...
                <div class="mt-8 gap-2 lg:columns-1 sm:columns-1">
                    <div class="flex flex-col justify-center">
                        ...
                        class="inline-flex items-center justify-center w-full h-12 gap-3 px-5 py-3 font-medium text-white bg-blue-500 rounded-xl hover:bg-blue-500 focus:ring-2 focus:ring-offset-2 focus:ring-black">
    ...
    <!-- Success Modal -->
    @if($showModal)
        <div class="fixed bg-white/80 backdrop-blur-md top-0 left-0 z-50 h-full w-full flex justify-center items-center">

                    ...
                    <form wire:submit.prevent="submit">
                        ...
                        <div>
                            ...
                            <div class="mt-12 gap-2 lg:columns-2 sm:columns-1">
                                <div class="w-full">
                                    <label for="firstname" class=" text-sm text-gray-700 font-bold">Firstname <span
                                ...
                                <div class="w-full">
                                    <label for="middlename" class=" text-sm text-gray-700 font-bold">Middlename</label>
                            ...
                            <div class="mt-4 gap-2 lg:columns-2 sm:columns-1">
                                <div class="w-full">
                                    <label for="last_name" class=" text-sm text-gray-700 font-bold">Lastname <span
                                            class="text-red-600">*</span></label>
                            ...
                            <div class="mt-4 gap-2 lg:columns-2 sm:columns-1">
                                <div class="w-full">
                                    <label for="email" class=" text-sm text-gray-700 font-bold">Email <span
                                            class="text-red-600">*</span></label>
                                ...
                                <div class="w-full">
                                    <label for="mobile_number" class=" text-sm text-gray-700 font-bold">Mobile Number <span
                                            class="text-red-600">*</span></label>
                                    <input type="text" id="mobile_number" wire:model.live="mobile_number"
                                        class="w-full h-12 px-4 py-2 text-black border rounded-lg appearance-none bg-chalk border-zinc-300 placeholder-zinc-300 focus:border-zinc-300 focus:outline-none focus:ring-zinc-300 sm:text-sm">
                                    @error('mobile_number')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                    @enderror
                        ...
                        <div class="mt-4 gap-2 lg:columns-1 sm:columns-1">
                            <div class="w-full">
                                <label for="street" class=" text-sm text-gray-700 font-bold">Street <span
                                    class="text-red-600">*</span></label>

<div class="w-full bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-md mt-6">
    ...
    <div class="mb-4">
        <div class="relative">
            <input type="text" 
                ...
                placeholder="Search dimensions or indicators..."
                class="w-full px-4 py-2 pl-10 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500">

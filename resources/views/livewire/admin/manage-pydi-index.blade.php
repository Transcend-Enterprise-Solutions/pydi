                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg w-full max-w-md p-6">
                    ...
                    <div class="flex justify-end gap-2">
                        <button wire:click="$set('showActionModal', false)"
                            class="px-4 py-2 border rounded dark:border-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700">Cancel</button>
                        <button wire:click="submitAction" wire:loading.attr="disabled"
                            class="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 flex items-center gap-2 disabled:opacity-50">
                ...
                <div class="w-full max-w-md p-6 mx-4 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
                    ...
                    <div class="flex justify-between gap-3">
                        <button wire:click="processEditRequest('reject')" title="Reject the edit request"
                            class="flex-1 px-4 py-2 text-sm font-medium text-white bg-red-600 rounded-md hover:bg-red-700 focus:outline-none transition disabled:opacity-50"
                            wire:loading.attr="disabled">
                            <span wire:loading.remove wire:target="processEditRequest('reject')">
                                <i class="bi bi-x-circle mr-1"></i> Reject
                            </span>
                            <span wire:loading wire:target="processEditRequest('reject')" class="flex items-center gap-2">
                                <i class="fas fa-spinner fa-spin"></i> Processing...
                            </span>
                        </button>
                        <button wire:click="processEditRequest('approve')" title="Approve the edit request"
                            class="flex-1 px-4 py-2 text-sm font-medium text-white bg-green-600 rounded-md hover:bg-green-700 focus:outline-none transition disabled:opacity-50"
                            wire:loading.attr="disabled">
                            <span wire:loading.remove wire:target="processEditRequest('approve')">
                                <i class="bi bi-check-circle mr-1"></i> Approve
                            </span>
                            <span wire:loading wire:target="processEditRequest('approve')" class="flex items-center gap-2">
                                <i class="fas fa-spinner fa-spin"></i> Processing...
                            </span>
                        </button>
                    </div>

    ...
    <div class="flex justify-center w-full">
        <div class="w-full bg-white rounded-2xl p-3 sm:p-6 shadow dark:bg-gray-800 overflow-x-visible">
            <div class="pb-4 mb-3 pt-4 sm:pt-0">
                <h1 class="text-lg font-bold text-center text-slate-800 dark:text-white">Monthly Water Bills</h1>
            </div>
                            ...
                            <div>
                                <div class="overflow-hidden border dark:border-gray-700 rounded-lg">
                                    <div class="flex justify-center pt-4 bg-gray-200 dark:bg-gray-700">
                                        <h1>Water Bill for the month of {{ \Carbon\Carbon::parse($month)->format('F Y') }}</h1>
                                    </div>
